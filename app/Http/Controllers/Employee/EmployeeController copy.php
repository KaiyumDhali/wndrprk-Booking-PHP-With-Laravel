...
class EmployeeController extends Controller {
    ...
    public function employeeProfile() {
        ...
        return view('pages.employee.employees.profile', compact('employee', 'employee_educations', 'employee_job_histories'));
    }
    ...
    public function edit(Employee $employee) {
        ...
        if (auth()->user()->hasRole('employee')) {
            return view('pages.employee.employees.profile_update', compact('employeeJobHistorys', 'employee', 'allEmpBranch', 'allEmpDepartment', 'allEmpDesignation', 'empEducations'));
        } else {
            return view('pages.employee.employees._employee-update', compact('employeeJobHistorys', 'employee', 'allEmpBranch', 'allEmpDepartment', 'allEmpDesignation', 'empEducations'));
        }
    }
