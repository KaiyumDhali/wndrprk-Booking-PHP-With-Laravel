...
class EmployeeLeaveApproveDeptController extends Controller
{
    ...
    public function index()
    {
        ...
        $branchIds = $employeeDetails->pluck('branch_id');
        ...
        // dd($branchEmployeeDetails);

        $allEmpBranch = EmpBranch::where('status', 1)->pluck('branch_name', 'id')->all();
        return view('pages.employee.employee_leave_approve_dept.index', compact('allEmpBranch', 'employeeDetails', 'branchEmployeeDetails'));
    }
