    ...
    public function store(Request $request)
    {
        ...
        if ($totalMonthlySalaryEmployeeIds->count() > $addedMonthlySalaryEmployeeIds->count()) {
            ...
            foreach ($newEmployeeIds as $employeeId) {
                $basic_salary_amount = EmpPosting::where('employee_id', $employeeId)->orderBy('id', 'desc')->value('gross_salary');
                // dd($basic_salary_amount);
                ...
                $total_income = Income::where('employee_id', $employeeId)->sum('amount');
                $total_deduction = Deduction::where('employee_id', $employeeId)->sum('amount');
                ...
                $incomes = Income::with(['incomeHead'])->where('employee_id', $employeeId)->get();
                ...
                $deductions = Deduction::with(['deductionHead'])->where('employee_id', $employeeId)->get();
