...
// dd($monthlySalaries);
    ...
    public function store(Request $request)
    {
        ...
        $addedMonthlySalary = MonthlySalary::where('salary_month', '=', $salary_month)->where('branch_id', $branch_id)->pluck('employee_id');
        // find Employee table this branch_id and joining_date match id
        $totalMonthlySalaryEmployee = Employee::where('branch_id', $branch_id)->where('joining_date', '<=', date($salary_month . '-t'))->count();
        ...
        if ($totalMonthlySalaryEmployee > count($addedMonthlySalary)) {
            ...
            //dd($remainingEmp);         
            $basic_salary = EmployeeSalary::whereIn('employee_id', $remainingEmp)->pluck('employee_id');
        //    dd($basic_salary);
            ...
            foreach ($findNewEmployees as $employee) {
                $basic_salary_amount = EmployeeSalary::where('employee_id', $employee->id)->orderBy('id', 'desc')->value('amount');
