...
class SetSalaryController extends Controller
{
    ...
    public function setSalariesCreate($employee_id)
    {
        ...
        return view('pages.payroll.set_salaries.create', compact('employee_id', 'payslipTypes', 'employeeSalary', 'allowanceOptions', 'allowances', 'commissions', 'loanOptions', 'loans', 'otherPayments', 'overtimes'));
    }
