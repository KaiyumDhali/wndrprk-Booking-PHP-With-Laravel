...
class FinanceTransactionController extends Controller
{
    ...
    public function paymentVoucherStore(Request $request)
    {
        ...
        $formatAmount = formatCurrency($amount);
        if ($bank_name) {
            $narration[] = "$acid_name Payment To: $to_acc_name, Through Bank:$bank_name, Branch:$branch_name, A/C:$ac_no, Cheque No:$cheque_no, Cheque Date:$cheque_date, Payment Amount:$formatAmount TK\n";
        } else if ($mobile_bank_name) {
            $narration[] = "$acid_name Payment To: $to_acc_name, Through Mobile Bank:$mobile_bank_name, Transaction ID:$transaction_id,  Payment Amount:$formatAmount TK\n";
        } else {
            $narration[] = "$acid_name Payment To: $to_acc_name, Through Cash Payment Payment Amount:$formatAmount TK\n";
        }
        $narration = implode("\n", $narration);
        echo $narration;
