...
class SalesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($givenAmount > 0) {
                ...
                if ($bank_name) {
                    $narration[] = "Invoice:$salesNumber, $payAccName Received From $customerName, Bank:$bank_name, Branch:$branch_name, A/C:$ac_no, Cheque No:$cheque_no, Date:$cheque_date, Amount:$formatAmount TK\n";
    ...
    public function salesInvoiceDateSearch($startDate, $endDate, $pdf)
    {
        ...
        if ($pdf == "pdfurl") {
            ...
            $pdf = PDF::loadView('pages.pdf.sales_date_wise_report_pdf', array('dateWiseSalesSearch' => $salesInvoices, 'data' => $data));
