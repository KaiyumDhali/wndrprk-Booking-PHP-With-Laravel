...
class ProductOrderController extends Controller
{
    ...
    public function show( $id)
    {
        ...
        return view('pages.product.product_order.show',compact('productOrder', 'productOrderDetails', 'productOrderDetailsChains'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.product.product_order.edit',compact('allCustomers', 'allColors', 'allSizes', 'productOrder', 'productOrderDetails', 'productOrderDetailsChains'));
    }
