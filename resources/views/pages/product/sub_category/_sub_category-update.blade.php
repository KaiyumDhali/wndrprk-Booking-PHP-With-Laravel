        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container">
                <form id="kt_ecommerce_add_category_form"
                    ...
                    action="{{ route('sub_category.update', $subCategory->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Aside column-->
                                        ...
                                        <div class="fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                             ...
                                             <select class="form-select form-select-sm" data-control="select2" name="category_id" required>
                                                <option selected disabled>Update Parent Category</option>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="card-body pt-0 pb-5">
                                        ...
                                        <div class="fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="sub_category_name" class="form-control form-control-sm mb-2"
