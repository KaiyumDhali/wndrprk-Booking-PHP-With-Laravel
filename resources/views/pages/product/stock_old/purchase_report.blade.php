                        ...
                        <div class="d-flex flex-column gap-5 gap-lg-5">
                            <div class="d-flex flex-column flex-xl-row gap-5 gap-lg-5">
                                ...
                                <div class="card card-flush flex-row-fluid overflow-hidden"
                                    ...
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body py-0">Supplier ID : {{$stocks[0]->supplier->id}}
                                        <br>Supplier Name : {{$stocks[0]->supplier->supplier_name}}
                                        <br>Address : {{$stocks[0]->supplier->supplier_address}}
                                        <br>Mobile No : {{$stocks[0]->supplier->supplier_mobile}}
                                    </div>
                                    <!--end::Card body-->
                                </div>
                                <!--end::Payment address-->
