<x-default-layout>
                                ...
                                <div class="col-md-12 pb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm form-control-solid" readonly id="purchase_unit"
                                                    name="purchase_unit " />
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="order">{{ __('Price (Per Unit)') }}</label>
                                                <input type="number" class="form-control form-control-sm form-control-solid" id="purchase_price"
                                                    name="purchase_price" />
                                            </div>
                                            <div class="form-group col-md-3">
                ...
                <div class="col-md-4">
                    <div class="card shadow px-10 pb-8">
                        ...
                        <div class="form-group">
                            ...
                            <select id="changeSupplier" class="form-control form-control-sm" name="supplier_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="" name="supplier_invoice_no" value="" />
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" id="" class="btn btn-sm btn-success px-5 mt-5">{{ __('Purchase') }}</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <script type="text/javascript">
        ...
        $('#table_product_quantity').on('change', function() {
            ...
            let update_quantity= (purchase_price * table_product_quantity) - discount;
                ...
                if(quantity > 0){
                    ...
                    if (duplicate_found) {
                        ...
                        `<tr data-id="${id}">
                            ...
                            <td>` + purchase_price + `<input type="hidden" name="table_product_price[]" value=`+ purchase_price +` ></td>
