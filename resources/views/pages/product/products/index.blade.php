                    ...
                    <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                        ...
                        <thead class="bg-gray-200">
                            ...
                            <tr class="text-start fw-bold fs-7 text-uppercase gs-0 ">
                                ...
                                <th class="min-w-100px">Product Type</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-dark text-hover-primary">{{ $product->product_name }}</a>
                                    </td>
                                    <td>
                                        <div class="badge badge-light-{{ $product->status == 1 ? 'success' : 'info' }}">
                                            {{ $product->status == 1 ? 'Active' : 'Disabled' }}</div>
                                    </td>
                                    <td>
                                        @if (!is_null($product) && !is_null($product->product_code))
                                            <span class="">
                                                <span class="">{{ $product->product_code }}</span>
                                                {!! DNS1D::getBarcodeHTML($product->product_code, 'C128', 1.5, 30, 'black') !!}
                                            </span>
                                        @endif
                                    </td>
