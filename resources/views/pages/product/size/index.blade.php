                    ...
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"
                        ...
                        <thead>
                            ...
                            <tr class="text-start fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Size Name</th>
                                <th class="min-w-100px">Size Status</th>
                                @can('write size')
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach ($sizes as $size)
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-dark text-hover-primary">{{ $size->size_name }}</a>
                                    </td>
                                    <td>
                                        <div class="badge badge-light-{{ $size->status == 1 ? 'success' : 'info' }}">
                                            {{ $size->status == 1 ? 'Active' : 'Disabled' }}</div>
                                    </td>
                                    @can('write size')
                                        <td class="text-end">
