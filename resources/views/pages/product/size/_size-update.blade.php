        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container">
                <form id="kt_ecommerce_add_category_form"
                    ...
                    action="{{ route('sizes.update', $size->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Aside column-->
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <select class="form-select form-select-sm" data-control="select2" name="status">
                                    ...
                                    <option value="0" {{ $size->status==0?'selected':'' }}>Disable</option>
                                </select>
                            </div>
                            <!--end::Card body-->
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div class=" fv-row fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="required form-label">Size Name</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="size_name" class="form-control form-control-sm"
