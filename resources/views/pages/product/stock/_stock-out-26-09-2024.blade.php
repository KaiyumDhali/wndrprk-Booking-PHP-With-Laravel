        ...
        <div class="col-md-4">
            <div class="card shadow px-10 pb-8 ms-0 ms-md-5">
                ...
                {{-- <div class="card-body px-0 pb-2 d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-sm btn-flex btn-light-primary ms-2 mt-8" data-bs-toggle="modal"
...
<script type="text/javascript">
    ...
    $('#addProduct').on('click', function() {
        ...
        let quantityAmount = $('#quantityAmount').val();
        ...
        if (product_id && quantity > 0) {
            ...
            if (duplicate_found) {
                ...
                let newAmount = oldAmount + parseFloat(quantityAmount || 0) - newDiscount;
                    // newAmount = newAmount-newDiscount;
