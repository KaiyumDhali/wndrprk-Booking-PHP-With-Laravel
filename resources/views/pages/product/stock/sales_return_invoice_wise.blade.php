            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        <h3>Invoice Wise Sales Return</h3>
                    </div>
                    <!--begin::Card toolbar-->
...
<script type="text/javascript">
    ...
    function InvoiceList(pdfdata) {
        ...
        url = '{{ route('sales_invoice_return_list_search', ['startDate' => ':startDate', 'endDate' => ':endDate', 'pdf' => ':pdf']) }}';
                ...
                success: function(data) {
                    ...
                    if (data) {
                        $.each(data, function(key, value) {
                            ...
                            // URLs
                            let showUrl =
                                `{{ route('sales_invoice_return_details', ['invoiceNo' => '_invoiceNo_']) }}`
                                .replace('_invoiceNo_', invoiceNo);
                            let pdfUrl =
                                `{{ route('sales_invoice_return_details_Pdf', ['data' => '_invoiceNo_']) }}`
                                .replace('_invoiceNo_', invoiceNo);
