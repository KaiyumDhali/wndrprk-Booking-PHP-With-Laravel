            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-2 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        <h3>Material Wise Stock Report</h3>
                    </div>
                    <!--begin::Card toolbar-->
...
<script type="text/javascript">
    ...
    var table = $('#material_wise_stock_report').DataTable(dataTableOptions);
    ...
    function CallBack(pdfdata) {
        ...
        url =
            '{{ route('stock_report_material_wise_search', ['startDate' => ':startDate', 'endDate' => ':endDate', 'pdf' => ':pdf']) }}';
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            table.row.add([d.id, d.product_name, d.unit_id, PreQtyCell, InQtyCell, TotQtyCell, OutQtyCell, balanceCell
                            ]).draw();
                        });
