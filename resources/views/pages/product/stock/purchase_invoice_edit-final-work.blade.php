...
<script type="text/javascript">
    ...
    function loadProductsFromData() {
        getData.forEach(product => {
            const stock_in_total_amount = parseFloat(product.stock_in_total_amount) || 0; // Convert to number, default to 0 if NaN
            const discount = parseFloat(product.stock_in_discount) || 0; // Convert to number, default to 0 if NaN
            addProductRow({
                ...
                // discount: product.stock_in_discount || 0, // If discount is null, use 0
