                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="changeAccountsName" class="form-control form-control-sm"
                                            name="pay_account" data-control="select2"
...
<script type="text/javascript">
    ...
    $('#cart_product').on('keyup', 'input[name="table_product_quantity[]"]', function(e) {
        ...
        let update_amount = ((quantity * purchase_price) - discount).toFixed(2);
        ...
        let calculateNetTotal = parseFloat(update_amount) - currentTotal;
        let finalAmount = getAmount + calculateNetTotal;

        // Update the total amount
        $('#netTotalAmount').val(finalAmount.toFixed(2));
