            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--end::Filter-->
                        @can('create color')
                            <a href="{{ route('colors.create') }}" class="btn btn-primary btn-sm">Add Color</a>
                        @endcan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"
                        ...
                        <thead>
                            ...
                            <tr class="text-start fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Color Name</th>
                                <th class="min-w-100px">Color Status</th>
                                @can('write color')
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach ($colors as $color)
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-dark text-hover-primary">{{ $color->color_name }}</a>
                                    </td>
                                    <td>
                                        <div class="badge badge-light-{{ $color->status == 1 ? 'success' : 'info' }}">
                                            {{ $color->status == 1 ? 'Active' : 'Disabled' }}</div>
                                    </td>
                                    @can('write color')
                                        <td class="text-end">
