                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="unit_name" class="form-control form-control-sm mb-2"
                                        placeholder="Unit name" value="" required>
                                    <!--end::Input-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <div class="fv-row fv-plugins-icon-container">
                                    <label class="required form-label">Unit Value</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="unit_value" class="form-control form-control-sm mb-2"
                                        placeholder="Unit Value" value="" required>
                                    <!--end::Input-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Input group-->
