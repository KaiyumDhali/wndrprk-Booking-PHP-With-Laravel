                    ...
                    id="kt_ecommerce_report_customer_orders_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start fs-7 text-uppercase gs-0">
                                <th class="min-w-100px">Unit Name</th>
                                <th class="min-w-100px">Unit Value</th>
                                <th class="min-w-100px">Unit Status</th>
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="text-dark text-hover-primary">{{$unit->unit_name}}</a>
                                </td>
                                <td>
                                    <a class="text-dark text-hover-primary">{{$unit->unit_value}}</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-{{$unit->status==1 ? 'success' : 'info'}}">{{ $unit->status==1?'Active':'Disabled' }}</div>
                                </td>
                                @can('write unit')
                                    <td class="text-end">
