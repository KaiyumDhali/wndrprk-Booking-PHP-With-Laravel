<x-default-layout>
    ...
    <div class="container-fluid">
        ...
        @endif
        <form id="" method="POST" action="{{ route('sales_search') }}" enctype="multipart/form-data">
            @csrf
            <div class="row pt-10">
                <!-- Content Row -->
                        ...
                        <div class="col-md-12 card shadow">
                            <div class="card-header py-0">
                                <div class="d-sm-flex align-items-center justify-content-between">
                                    <h1 class="h3 mb-0 text-gray-800">{{ __('Product Sales Report') }}</h1>
                                </div>
                        ...
                        <div class="d-flex flex-column gap-5 gap-lg-5">
                            <div class="d-flex flex-column flex-xl-row gap-5 gap-lg-5">
                                ...
                                <div class="card card-flush flex-row-fluid overflow-hidden"
                                    ...
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body py-0">Customer ID : {{$stocks[0]->customer->id}}
                                        <br>Customer Name : {{$stocks[0]->customer->customer_name}}
                                        <br>Address : {{$stocks[0]->customer->customer_address}}
                                        <br>Mobile No : {{$stocks[0]->customer->customer_mobile}}
                                    </div>
                                    <!--end::Card body-->
                                </div>
                                <!--end::Payment address-->
                                        ...
                                        <table class="table table-striped table-bordered align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-end">
                                                        {{number_format($stock->stock_out_unit_price, 2)}}</td>
                                                    <td class="text-end">
                                                        {{number_format($stock->stock_out_discount, 2)}}</td>
                                                    {{-- <td class="text-end">{{$productTotal =(($stock->stock_in_quantity * $stock->stock_in_unit_price) - $stock->stock_in_discount)}}
                                                    </td> --}}
                                                    <td class="text-end">
                                                        {{ number_format($productTotal =($stock->stock_out_quantity * $stock->stock_out_unit_price),2) }}
                                                    </td>
                                                    <span
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="6" class="text-dark fs-4 fw-bolder text-end">
                                                        {{ number_format($customerPayment,2) }} </td>
                                                    </tr>
                                                <tr>
