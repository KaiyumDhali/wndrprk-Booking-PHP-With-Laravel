            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--end::Filter-->
                        @can('create category')
                            <a href="{{ route('category_create.create') }}" class="btn btn-primary btn-sm">Add Category</a>
                        @endcan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"
                        ...
                        <thead>
                            ...
                            <tr class="text-start fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Category Status</th>
                                @can('write category')
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-dark text-hover-primary">{{ $category->category_name }}</a>
                                    </td>
                                    <td>
                                        <div
                                            class="badge badge-light-{{ $category->status == 1 ? 'success' : 'info' }}">
                                            {{ $category->status == 1 ? 'Active' : 'Disabled' }}</div>
                                    </td>
                                    @can('write category')
                                        <td class="text-end">
                                            <a href="{{ route('category_edit.edit', $category->id) }}"
