                        ...
                        <div class="d-flex flex-column gap-5 gap-lg-5">
                            <div class="d-flex flex-column flex-xl-row gap-5 gap-lg-5">
                                ...
                                <div class="card card-flush flex-row-fluid overflow-hidden pt-3"
                                    ...
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <div class="card-body py-0 pt-2">Customer ID : {{$stocks[0]->customer_finance_account->id}}
                                        <br>Customer Name : {{$stocks[0]->customer_finance_account->account_name}}
                                ...
                                <div class="card card-flush py-0 flex-row-fluid overflow-hidden"
                                    ...
                                    <div class="card-body pt-5">
                                        <a href="{{ route('sales_search_pdf',$stocks[0]->invoice_no) }}" class="btn btn-sm btn-primary px-5 my-3" target="_blank">{{ __('PDF Download') }}</a>
