                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="order">{{ __('Quantity') }}</label>
                                                <input type="text" class="form-control form-control-sm" id="productQuantity" name="quantity"
                                        ...
                                        <div class="form-group col-md-2 d-none" id="percentageInputContainer">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="percentage" id="percentageInput"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        </div>

                                        <div class="form-group col-md-2" id="amountInputContainer">
                                            <label class=""><span class="">Discount </span> </label>
                ...
                <div class="col-md-4">
                    <div class="card shadow px-10 pb-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="givenAmount" name="givenAmount" value="0"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                        </div>
                        <div class="form-group">
                ...
                if (duplicate_found) {
                    ...
                    $('#product_add').append(
                        ...
                        product_id + ` ></td>
                            ...
                            <td class="text-end">` + purchase_price + `<input type="hidden" name="table_product_price[]" value=` +
                        purchase_price + ` ></td>
                            <td class="text-end">` + discount + `<input type="hidden" name="table_product_discount[]" value=` +
                        discount + ` ></td>
                ...
                success: function(data) {
                    if (data) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            var due = (credit - debit).toFixed(2);
