            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container">
                    <form id="receivedVoucherform"
                        ...
                        method="POST" action="{{ route('received_voucher_store') }}" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Main column-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                <label class="required form-label">{{ __('Payment Type') }}</label>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="card-body pt-0 pb-3">
                                            <div class="fv-row fv-plugins-icon-container">
                                                <label class="required form-label">To Account Name</label>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                <label class="required form-label">Received From</label>
                                                <select id="receivedFrom" class="form-select form-select-sm"
                                                    name="received_from" data-control="select2" data-hide-search="false"
                                                    required>
                                                    <option value="" selected>Select Account Name</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="card-body pt-0 pb-3">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="remarks" class="form-control form-control-sm mb-2" placeholder="narration"
                                                    value="">
                                            </div>
                                        </div>
                                    </div>
...
<script>
    document.getElementById("receivedVoucherform").addEventListener("keydown", function(event) {
        ...
        function CallBack() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Populate options in receivedFrom select
                    // $('#receivedFrom').append(
                    //     '<option value="" selected>-- Select Received From --</option>');
    ...
    var table = $('#received_voucher_table').DataTable(dataTableOptions);

    function InvoiceList(startDate, endDate, pdfdata) {
        let url;
        url =
            "{{ route('received_voucher_date_search', ['startDate' => ':startDate', 'endDate' => ':endDate', 'pdf' => ':pdf']) }}";
