            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        let showUrl = `{{ route('received_voucher_report_pdf', ['voucherNo' => '_voucherNo_']) }}`.replace('_voucherNo_', voucherNo);
                        let view = `
                            <td>
                                <a href="${showUrl}" class="btn btn-sm btn-info hover-scale p-2" data-bs-toggle="tooltip" data-bs-placement="top" title="View" target="_blank">
                        ...
                        let viewCell = '<div style="text-align: center;">' + view + '</div>';
