                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <select id="paymentType" class="form-control form-control-sm" name="payment_type"
                                                    data-control="select2" data-placeholder="Select Payment Type">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div class="card-body pt-0 pb-2">
                                                <div class="fv-row fv-plugins-icon-container">
                                                    ...
                                                    <select id="" class="form-control form-control-sm" name="cheque_type"
            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        let to_acc_name = value[1].to_acc_name;
                        let to_acc_name_2 = value[0].to_acc_name;
