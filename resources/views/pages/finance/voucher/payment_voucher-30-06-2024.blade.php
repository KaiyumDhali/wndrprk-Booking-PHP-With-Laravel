            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        let showUrl = `{{ route('payment_voucher_report_pdf', ['voucherNo' => '_voucherNo_']) }}`.replace('_voucherNo_', voucherNo);
                        let view = `
                            <td class="d-flex flex-row">
                                <a href="${showUrl}" class="btn btn-sm btn-success hover-scale m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="View" target="_blank">
                                    Payment Voucher
                                </a>
                                <a href="${showUrl}" class="btn btn-sm btn-info hover-scale m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="View" target="_blank">
                                    Debit Voucher
                                </a>
                                <a href="${showUrl}" class="btn btn-sm btn-warning hover-scale m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="View" target="_blank">
                                    Journal Voucher 
                                </a>
                            </td>
                        `;
