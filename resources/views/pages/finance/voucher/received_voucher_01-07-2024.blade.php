...
<script>
    ...
    function InvoiceList(startDate, endDate) {
        let url;
        url = "{{ route('received_voucher_date_search', ['startDate' => ':startDate', 'endDate' => ':endDate']) }}";
            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        let receivedVoucherUrl = `{{ route('voucher_report_pdf', ['voucherNo' => '_voucherNo_', 'voucherType' => 'receivedVoucher']) }}`.replace('_voucherNo_', voucherNo);
                        let creditVoucherUrl = `{{ route('voucher_report_pdf', ['voucherNo' => '_voucherNo_', 'voucherType' => 'creditVoucher']) }}`.replace('_voucherNo_', voucherNo);
                        let receivedJournalVoucher = `{{ route('voucher_report_pdf', ['voucherNo' => '_voucherNo_', 'voucherType' => 'receivedJournalVoucher']) }}`.replace('_voucherNo_', voucherNo);
