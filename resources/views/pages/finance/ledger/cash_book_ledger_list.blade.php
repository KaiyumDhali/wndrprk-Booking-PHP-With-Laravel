...
<script type="text/javascript">
    ...
    var table = $('#cash_book_ledger').DataTable(dataTableOptions);
    ...
    function CallBack(pdfdata) {
        ...
        url =
            '{{ route('cash_book_ledger_search', ['accountHead' => ':accountHead', 'startDate' => ':startDate', 'endDate' => ':endDate', 'pdf' => ':pdf']) }}';
