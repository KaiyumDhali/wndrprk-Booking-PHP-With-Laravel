...
<script type="text/javascript">
    ...
    $('#productionQuantity').on('change', OnchangeCall);
    ...
    $('#addProductionProduct').on('click', function() {
        ...
        if(add_to_product_id > 0){
            ...
            $('#production_product_add tr').each(function() {
                if ($(this).find('input[name="production_product_id[]"]').val() === add_to_product_id) {
            ...
            if (duplicate_found) {
                ...
                $('#production_product_add').append(
                    `<tr data-id="${production_product_id_add}">
                        ...
                        <td>` + add_to_product_name + `<input type="hidden" name="add_to_product_id[]" value=`+ add_to_product_name +` ></td>
