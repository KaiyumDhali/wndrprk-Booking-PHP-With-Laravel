            ...
            if (consume_quantity > 0) {
                ...
                if (duplicate_found) {
                    ...
                    $('#add_to_consume_product_add').append(
                        ...
                        <td>` + consume_unit + `<input type="hidden" name="add_consume_product_unit[]" value=` + consume_unit_id + ` ></td>
                        <td>` + consume_quantity + `<input type="hidden" name="add_consume_product_quantity[]" value=` + consume_quantity + ` ></td>
                        <td>` + product_per_unit_price + `<input type="hidden" name="add_consume_unit_price[]" value=` + product_per_unit_price + ` ></td>
                        <td>` + product_total_price + `<input type="hidden" name="add_consume_total_price[]" value=` + product_total_price + ` ></td>
                    </tr>`
                    );
                    ++new_consume_id;
