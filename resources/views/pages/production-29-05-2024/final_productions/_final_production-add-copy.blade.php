                                    ...
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="number" class="form-control form-control-sm form-control-solid" value="" id="quantity" name="production_product_quantity" step="1" pattern="^[-\d]\d*$">
                                            </div>
                                            <div class="form-group col-md-2">
                    ...
                    if (data2) {
                        ...
                        $.each(data2, function(key, value) {
                            ...
                            $('#quantity').on('change', function() {
                                ...
                                var new_product_quantity = per_product_quantity*change_product_quantity;
                            ...
                            console.log('final_product_quantity', final_product_quantity);
