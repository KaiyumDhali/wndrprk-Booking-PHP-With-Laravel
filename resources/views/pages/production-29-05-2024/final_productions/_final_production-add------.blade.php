                                    ...
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="hidden"
                                                    class="form-control form-control-sm form-control-solid" readonly
                                                    value="" id="productionUnitId" name="production_product_unit_id">
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label for="order">{{ __('Quantity') }}</label>
                                                <input type="number"
                                                    class="form-control form-control-sm form-control-solid"
                                                    value="" id="productionQuantity" name="production_product_quantity" step="1"
                                                    pattern="^[-\d]\d*$">
                                            </div>
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="number" id="productionUnitCost"
                                                    class="form-control form-control-sm form-control-solid" readonly
                                                    value="" id="unit_price" name="production_product_unit_price" step="1"
                                                    pattern="^[-\d]\d*$">
                                            </div>
                                            <div class="form-group col-md-2">
                                            ...
                                            <div class="form-group col-md-1">
                                                <button type="button" id="addProductionProduct" class="btn btn-sm btn-primary px-5 mt-6">{{ __('Add to Cart') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    if (data2) {
                        ...
                        $.each(data2, function(key, value) {
                            ...
                            if (type == 1) {
                                ...
                                var produceable_unit_price = consume_product_total_price / produceable_qty;                                
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data2) {
                        ...
                        $('#add_to_wastage_product_div').removeClass('d-none');
                        // $('#add_to_wastage_product_add').empty();
                        ...
                        $.each(data2, function(key, value) {
                            ...
                            if (type == 1) {
                                ...
                                $('#productionUnitCost').val(produceable_unit_price);
                                $('#productionTotalPrice').val(consume_product_total_price);
                                $('#add_to_consume_product_total_price').text(consume_product_total_price);
                                ...
                                wastage_product_total_price = wastage_product_total_price + product_total_price;
                                $('#add_to_wastage_product_total_price').text(wastage_product_total_price);

                                $('#add_to_wastage_product_add').append(
                                    `<tr data-id2="${wastage_id}">
                                    <td>` + product_id + `<input type="hidden" name="" value=` + product_id + ` ></td>
                                    <td>` + product_name + `<input type="hidden" name="wastage_product_id[]" value=` +
                                    product_id + ` ></td>
    ...
    $('#addProductionProduct').on('click', function() {
        ...
        if(add_to_product_id > 0){
            ...
            $('#production_product_add tr').each(function() {
                var a = $(this).find('input[name="add_to_product_id[]"]').val()
                console.log(add_to_product_id);
                console.log(a);
            ...
            if (duplicate_found) {
                ...
                $('#production_product_add').append(
                    `<tr data-id="${production_product_id_add}">
                        ...
                        <td>` + add_to_product_name + `<input type="hidden" name="add_to_product_id[]" value=`+ add_to_product_id +` ></td>
                        <td>` + add_to_unit_name + `<input type="hidden" name="add_to_unit_id[]" value=`+ add_to_unit_id +` ></td>
                        <td>` + add_to_quantity + `<input type="hidden" class="" style="width:80px" name="add_to_quantity[]" value=`+ add_to_quantity +` ></td>
                        <td>` + add_to_unit_cost + `<input type="hidden" class="" style="width:80px" name="add_to_unit_cost[]" value=`+ add_to_unit_cost +` readonly></td>
                        <td>` + add_to_total_price + `<input type="hidden" class="" style="width:80px" name="add_to_total_price[]" value=`+ add_to_total_price +` readonly></td>
        ...
        // let consume_id = 0;
        // let wastage_id = 0;
        // if (add_to_product_id) {
        //     $.ajax({
        //         url: 'productionDetails/' + add_to_product_id,
        //         type: "GET",
        //         data: {
        //             "_token": "{{ csrf_token() }}"
        //         },
