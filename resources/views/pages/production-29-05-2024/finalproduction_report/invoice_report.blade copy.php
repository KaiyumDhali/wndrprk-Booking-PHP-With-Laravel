...
//        die();
    @endphp
            ...
            <a href="{{ route('finalproduction_report_search_pdf',$invoice_no) }}" class="btn btn-sm btn-primary px-5 my-3" style="" target="_blank">{{ __('PDF Download') }}</a>
        </div>
    </div>
                    ...
                    <div class="card-body py-3">
                        <div class="row">
                            <div class="col-md-6 px-0 mx-0">
                                <div class="d-sm-flex align-items-center justify-content-between">
                                    <h1 class="h3 mb-0 text-gray-800">{{ __(' Produceable Products ') }}</h1>
                                </div>
                            ...
                            <div class="col-md-6 py-5 px-0 mx-0" style="text-align: right">
                                <h2 class="mb-0"> Invoice No (#{{$productionIn[0]->invoice_no}}) </h2>
                                <br>
            ...
            <div class="row px-5">
                <div class="col-md-12 card shadow px-5">
                    ...
                    <table class="table table-striped table-bordered text-center mt-4">
                        ...
                        <tfooter>
                            <tr>
                                <th colspan="5" class="fs-5 text-dark text-end">Total Consumed Price</th>
