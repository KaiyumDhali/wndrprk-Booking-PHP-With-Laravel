<x-default-layout>
    ...
    <div class="row p-5 pt-0">
                    ...
                    <div class="card-body py-3">
                        <div class="row">
                            <div class="col-md-6 px-0 mx-0">
                                ...
                                <table class="table table-striped table-bordered mt-4">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            <td class="text-center">{{$production->product_id}}</td>
                                            <td class="text-left">{{$production->product->product_name}}</td>
                                            <td class="text-center">{{$production->product->unit->unit_name}}</td>
                                            {{-- <td class="text-center">{{$production->stock_in_quantity}}</td>
                                            <td class="text-end">{{$production->product->purchase_price}}</td> --}}
                                            <td class="text-end">
                                                {{ number_format($production->product->purchase_price*$stock->stock_in_quantity, 2)}}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            {{-- <div class="col-md-6 py-5 px-0 mx-0" style="text-align: right">
                                ...
                                <a href="{{ route('requisition_invoice_report_pdf',$productionIn[0]->invoice_no) }}" class="btn btn-sm btn-primary px-5 my-3" style="" target="_blank">{{ __('PDF Download') }}</a>

                                <h4 class="mb-0"> Requisition No (#{{$productionIn[0]->invoice_no}}) </h4>
                                <br>
                                <p>Requisition Date : {{$productionIn[0]->stock_date}}</p>
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-sm btn-success px-5 mt-5 me-5" href="{{ route('production.requisition_list') }}">Back Requisition List</a>
        </div>
    </div>
    @endisset
