    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h3 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Bill of Materials List</h3>
                <!--end::Title-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--end::Menu-->
                        <!--end::Export dropdown-->
                        @can('create billofmaterials')
                        <a href="{{ route('billofmaterials.create') }}" class="btn btn-sm btn-primary">Add New</a>
                        @endcan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach ($productions as $production)
                                <tr>
                                    ...
                                    <td>{{ $production->unit->unit_name }}</td>
                                    <td>{{ $production->quantity }}</td>
                                    @can('write billofmaterials')
                                    <td class="text-end">
                                        <a href="{{ route('billofmaterials.edit', $production->id) }}" class="btn btn-sm btn-success hover-scale p-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                            <i class="bi bi-check2-square fs-2 ms-1"></i>
                                        </a>
                                        <a href="{{ route('billofmaterials.show', $production->id) }}" class="btn btn-sm btn-info hover-scale p-2" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
