                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            // Add a visual separator if the date changes
                            if (previousDate !== d.date) {
                                if (previousDate !== null) {
                                    // Add an empty row or separator (spanning all columns)
                                    table.row.add([
                                        `<tr class="table-separator"><td colspan="6" style="background-color: #f9f9f9; height: 10px;"></td></tr>`
                                    ]).draw(false);
                                }

                                // Add a date header row
                                table.row.add([
                                    `<tr class="table-date-header"><td colspan="6" style="background-color: #e9ecef; font-weight: bold;">Date: ${d.date}</td></tr>`
                                ]).draw(false);
                            }
