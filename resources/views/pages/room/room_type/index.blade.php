                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach ($roomTypes as $roomType)
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            class="badge badge-light-{{ $roomType->status == 1 ? 'success' : 'info' }}">
                                            {{ $roomType->status == 1 ? 'Active' : 'Disabled' }}</div>
                                    </td>
                                    @can('write product type')
                                        <td class="text-end">
                                            <form method="POST"
                                                action="{{ route('room_type.destroy', $roomType->id) }}"
                                                class="delete-product-type-form">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                                <button type="button" class="btn btn-sm btn-success p-2"
                                                    data-productType="{{ json_encode($roomType) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        method="POST" action="{{ route('room_type.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="text-center pt-15">
                            <a href="{{ route('room_type.index') }}" id="kt_modal_new_card_cancel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_edit_card_form_room_type"
                        ...
                        action="{{ route('room_type.update', ':productTypeId') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!--begin::Input group-->
