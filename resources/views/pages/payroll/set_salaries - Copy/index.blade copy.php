            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--end::Menu-->
                        <!--end::Export dropdown-->
                        <!-- <a href="{{ route('payslip_type.create') }}" class="btn btn-primary btn-sm">Add
                            Set Salaries</a> -->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @foreach($setSalaries as $setSalary)
                            <tr>
                                <td>
                                    <a>{{$setSalary->employee_code}}</a>
                                </td>
                                <td>
                                    <a>{{$setSalary->employee_name}}</a>
                                </td>
                                <td>
                                    <div class="badge badge-light-{{$setSalary->status==1 ? 'success' : 'info'}}">
                                        {{ $setSalary->status==1?'Active':'Disabled' }}</div>
                                </td>
                                <td class="text-end">
                                    <a href="{{ route('set_salaries.set_salaries_create', $setSalary->id) }}"
                                        class="btn btn-sm btn-success px-3 py-1">Create</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <form id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                <span class="required">Name Set Salaries</span>
