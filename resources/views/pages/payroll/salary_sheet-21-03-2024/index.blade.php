                    ...
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1 ">
                            <div class="card-body p-2">
                                <select class="form-select form-select-sm" id="selectBranchSearch" name="branch_id" required>
...
<script type="text/javascript">
    ...
    function CallBack(pdfdata) {
        ...
        var month = $('#kt_td_picker_year_month_only_search_input').val();
        url = '{{ route('monthly_salaries', ['branch_id' => ':branchID', 'month' => ':month', 'pdf' => ':pdf']) }}';
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            table.row.add([d.employee_order, d.employee_id, d.employee_name, d
                                .designation_name,
                                d.Base_Salary, d.House_Rent, d.Medical, d.PF, d.iOthers,
