...
<script>
    ...
    function submitSelectedRows() {
        ...
        selectedRows.each(function() {
            ...
            // let payrollHeadId = $('[name="payroll_head_id"]').val();
            ...
            // if (existingRow) {
            //     // If the combination exists, push the payrollHeadId to its array
            //     existingRow.payroll_head_ids.push(payrollHeadId);
            // } else {
            //     // If not, create a new row with the combination
            //     selectedData.push({
            //         'employee_id': employeeId,
            //         'payroll_head_ids': [payrollHeadId],
            //         'effective_date': effectiveDate
            //     });
            // }
        });
