                                            ...
                                            <tbody class="fw-semibold text-gray-700">
                                                @if ($employeeSalary)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                id="employeeSalaryAmount">{{ $employeeSalary->gross_salary }}</a>
                                                        </td>
                                                        <td>
                                                            <a>{{ $employeeSalary->joining_date }}</a>
                                                        </td>
                                                        {{-- <td>
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="kt_modal_new_card_form"
                                                ...
                                                {{-- <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <select class="form-select form-select-sm" data-control="select2" name="payslip_type">
                    ...
                    <div class="col-md-12 mb-5 mb-xl-7">
                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header align-items-center p-3 pt-0">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <a href="#"
                                        class="btn btn-sm btn-flex btn-primary py-2 px-3 {{ empty($employeeSalary->gross_salary) ? 'disabled' : '' }}"
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_new_card_form"
                                            ...
                                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2" name="income_head">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_new_card_form"
                                            ...
                                            <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2" name="deduction_head">
                                                    <option value="">--Select Type--</option>
