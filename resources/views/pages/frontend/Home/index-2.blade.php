...
<!-- Mirrored from designarc.biz/demos/hilltown/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2025 12:07:17 GMT -->
                ...
                <div class="row introduction_inner">
                    <div class="col-md-6">
                        <div class="introduction_img">
                            ...
                            <img src="img/introduction-img3.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                            ...
                            <div class="row intro_box_item_area">
                                <div class="col-xs-4">
                                    <div class="intro_box_item">
                                        <img src="img/icon/intro-icon-1.png" alt="">
                                        <h4>Restaurant</h4>
                                    </div>
                                </div>
                                <div class="col-xs-4">
                                    <div class="intro_box_item">
                                        <img src="img/icon/intro-icon-2.png" alt="">
                                        <h4>pick & drop</h4>
                                    </div>
                                </div>
                                <div class="col-xs-4">
                                    <div class="intro_box_item">
                                        <img src="img/icon/intro-icon-3.png" alt="">
                                        <h4>free wifi</h4>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="video_area">
            <div class="container">
                <div class="video_inner">
                    <a class="popup-youtube" href="https://www.youtube.com/watch?v=48uPk1SA37Y"><img src="img/icon/video-icon.png" alt=""></a>
                    <h4>virtual Tour</h4>
...
<!-- Mirrored from designarc.biz/demos/hilltown/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2025 12:07:19 GMT -->
</html>