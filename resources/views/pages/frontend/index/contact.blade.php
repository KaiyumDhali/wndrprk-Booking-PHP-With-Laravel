...
<main>
  ...
  <section class="get_contact_area">
            <div class="container" >
                <div class="row get_contact_inner"style="margin-top: 80px;">
                    <div class="col-md-6">
                        ...
                        <div class="right_contact_info">
                            ...
                            <div class="contact_info_list">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Email</h4>
                                        <a href="#">{{$contact->company_email}}</a>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <h4>Phone</h4>
                                        <a href="#">{{$contact->company_mobile}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="contact_map_area">
            <div class="container">
                <div id="mapBox2" class="mapBox2 row m0" 
                    ...
                    data-lon="-74.1522848" 
                    data-zoom="12" 
                    data-marker="{{asset('assets2/img/map-marker.png')}}" 
                    data-info="Najrulpara, Saint Martin island, Teknaf, Bangladesh"
                    data-mlat="40.701083"
