<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('dashboard') }}" action="{{ route('login') }}">
        ...
        <div class="text-center mb-11">
            @if (!empty($companySetting->company_logo_two))
            <a href="/" class="mb-12">
                    <img alt="Logo" src="{{ url(Storage::url($companySetting->company_logo_two)) }}" class="h-75px">
                </a>
            @else
                <p>Company Logo</p>
            @endif
            ...
            {{-- <a href="/" class="mb-12">
                <img alt="Logo" src="{{ asset('assets/media/logos/default-small.png') }}" class="h-75px">
            </a> --}}
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder my-3">
                Sign In
            </h1>
            <!--end::Title-->
            ...
            <div class="text-gray-500 fw-semibold fs-6">
                @if (!empty($companySetting->company_name))
