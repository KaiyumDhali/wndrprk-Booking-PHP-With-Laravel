                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-1">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="production_product_quantity" step="1" pattern="^[-\d]\d*$">
                                            </div>
                                            <div class="form-group col-md-2">
                ...
                success: function(response) {
                    ...
                    if (data2) {
                        ...
                        $.each(data2, function(key, value) {
                            ...
                            var product_per_unit_price = value.product.purchase_price;
                            var product_total_price = parseFloat((product_per_unit_price * product_quantity).toFixed(2));
                            var type = value.type;
                    ...
                    success: function(response) {
                        ...
                        if (data2) {
                            ...
                            $.each(data2, function(key, value) {
                                ...
                                var product_unit_id = value.product_unit;
                                var product_unit_name = value.unit.unit_name;
                                var product_quantity = (value.quantity/Rqty)*consumeQuantity;
                                    product_quantity = parseFloat(product_quantity.toFixed(2));
                                var product_per_unit_price = value.product.purchase_price;
                                var product_total_price = parseFloat((product_per_unit_price * product_quantity).toFixed(2));
