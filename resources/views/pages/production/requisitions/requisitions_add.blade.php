<x-default-layout>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            @endif
            <form id="final_productions_store" method="POST" action="{{ route('requisitions.store') }}"
                ...
                <div class="row px-5">
                                    ...
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                id="changeProduct" name="production_product_id">
                                            ...
                                            <div class="form-group col-md-1">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="productionQuantity" name="production_product_quantity"
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">

                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="order">{{ __('Unit Price') }}</label>
                    ...
                    <div class="col-md-12 p-5 d-none" id="produceable_products_div">
                        <div class="row">
                                    ...
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2" id="newChangeConsumeProduct" name="">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="newConsumeQuantity" name=""
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                            </div>
...
<script type="text/javascript">
        ...
        if (productID) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var wastage_product_total_price = 0;
                    if (data2) {
                        $('#produceable_products_div').removeClass('d-none');
    ...
    document.getElementById("submitAllProceed").addEventListener('click', function (event) { ConfarmMsg("final_productions_store", "Are You sure.. Want to Save?", "save", event) });
