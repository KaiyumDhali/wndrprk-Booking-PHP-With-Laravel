                                    ...
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2" id="changeProduct" name="produced_product_id" >
                                    ...
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2" id="changeConsumeProduct" name="" >
                                                    <option selected disabled>Select Product</option>
                                ...
                                <div class="card-body py-3">
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>{{ __('Material Product') }}</label>
                                                <select class="form-select form-select-sm" data-control="select2" id="changeWastageProduct" name="" >
                                                    <option selected disabled>Select Product</option>
