    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h3 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Suppliers
                    List</h3>
                <!--end::Title-->
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--end::Export dropdown-->
                        @can('create supplier')
                            <a href="{{ route('suppliers.create') }}" class="btn btn-sm btn-primary">Add
                                Suppliers</a>
                        @endcan
                    </div>
                    <!--end::Card toolbar-->
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            ...
                            @foreach ($suppliers as $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-dark text-hover-primary">{{ $supplier->supplier_name }}</a>
                                    </td>
                                    <td>
                                        <div class="badge badge-light-{{ $supplier->status == 1 ? 'success' : 'info' }}">
                                            {{ $supplier->status == 1 ? 'Active' : 'Disabled' }}</div>
                                    </td>
