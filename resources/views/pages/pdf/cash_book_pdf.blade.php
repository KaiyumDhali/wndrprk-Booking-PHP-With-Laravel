...
<body style="font-size:12px">
    ...
    <div class="text-center">
        <h5 class="pb-0 mb-0 pt-0 pdf_title">Cash Book </h5>
        {{-- <h6 class="pb-0 mb-0 pt-0">{{$accountHead['account_name']}}</h6> --}}
        <h6 class="pb-0 mb-0 pt-0">{!! str_replace('A/C', '<br>A/C', $accountHead['account_name']) !!}</h6>
        ...
        @if ($bank_book)
            <thead class="text-light bg-secondary ">
                <tr class="text-uppercase text-center" style="font-size: 13px; font-weight: bold">
                    <th scope="col" class="text-center align-middle" width="15px">SL</th>
                    <th scope="col" class="text-center align-middle" width="65px">Date</th>
                    <th scope="col" class="text-center align-middle" width="100px">Particulars</th>
                    <th scope="col" class="text-center align-middle" width="60px">Vch Type</th>
                    <th scope="col" class="text-center align-middle" width="60px">Vch No</th>
                    <th scope="col" class="text-center align-middle" width="90px">Debit Amount</th>
                    <th scope="col" class="text-center align-middle" width="90px">Credit Amount</th>
                    <th scope="col" class="text-center align-middle" width="110px">Balance (BDT)</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                @foreach ($bank_book as $general_ledgers)
                    <tr>
                        <td>
                            {{ $sl}}
                        </td>
                        <td>
                            @if (!$general_ledgers->voucher_no)
                        ...
                        <td>
                            ...
                            @endphp
                            <span style="font-size: 14px; font-style: italic; font-weight: bold">{{ $type }}</span>
                        </td>
                        <td>
                        ...
                        <td style="text-align: right;">
                            @php 
                                ...
                                $balanceFormat = ($balance >= 0) ? formatCurrency($balance) . ' Dr' : '('.formatCurrency(abs($balance)).')' . ' Cr';
                            @endphp
                            {{$balanceFormat}}
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    @endphp
                    <td style="font-weight: bold; text-align: right;"><span
                            class="double-underline">{{$balanceFormat}}</span></td>
                </tr>
            </tbody>
        @else
