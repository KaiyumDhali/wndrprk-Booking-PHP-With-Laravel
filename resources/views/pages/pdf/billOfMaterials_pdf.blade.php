...
<body style="font-size:12px">
    ...
    <div class="text-center">
        <h5 class="pb-0 mb-0 pt-0 pdf_title">Bill Of Materials</h5>
        <p>{{ \Carbon\Carbon::parse($productionIn->created_at)->translatedFormat('d F Y') }}</p>
    </div>
    ...
    <table class="table text-center" style="border: none; border-top: none; margin-top: 110px;">
        <tr>
