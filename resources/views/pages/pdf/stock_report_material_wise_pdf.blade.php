...
<head>
    ...
    <title>Material Wise Stock Report</title>
...
<body style="font-size:12px">
    ...
    <div class="text-center">
        <h5 class="pb-0 mb-0 pt-0 pdf_title">Material Good Wise Stock Report</h5>
    ...
    <table class="table table-bordered table-striped table-sm table-hover">
        ...
        <tbody class="fw-semibold text-gray-600">
            @foreach ($stockReportMaterialWise as $key => $stock)
                <tr>
