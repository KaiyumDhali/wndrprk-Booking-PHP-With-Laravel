...
<body style="font-size:12px">
        ...
        <tbody>
            <tr class="text-center">
                <td>
                    ...
                    <h5 class="pb-0 mb-0 pt-0 pdf_title">General Ledger Report </h5>
                    {{-- <h6 class="pb-0 mb-0 pt-0">General Ledger Report</h6> --}}
    ...
    <table class="" style="position: absolute; margin-top: -145px;" align="start">
        <tbody>
            <tr class="text-center">
                <td>
        ...
        @if ($generalLedger)
            <thead class="text-light bg-secondary ">
                <tr class="text-uppercase text-center" style="font-size: 13px; font-weight: bold">
                    ...
                    <th scope="col" class="text-center align-middle"  width="90px">Balance (BDT)</th>
                </tr>
            </thead>
            <tbody>
                @php
