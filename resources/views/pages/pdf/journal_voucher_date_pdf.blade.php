...
<body style="font-size:12px">
    ...
    <div class="text-center">
        <h5 class="pb-0 mb-0 pt-0 pdf_title">Journal Voucher</h5>
        ...
        @if ($receivedVouchers)
            <thead class="text-light bg-secondary ">
                <tr class="text-uppercase text-center" style="font-size: 13px; font-weight: bold">
                    ...
                    <th scope="col" class="text-center align-middle"  width="80px">Amount</th>
            ...
            <tbody>
                ...
                @foreach ($receivedVouchers as $receivedVoucher)
                    <tr>
                        ...
                        <td>{{ $receivedVoucher->payment_type }}</td>
                        <td>{{ $receivedVoucher->amount }} {{ $receivedVoucher->balance_type }}</td>
