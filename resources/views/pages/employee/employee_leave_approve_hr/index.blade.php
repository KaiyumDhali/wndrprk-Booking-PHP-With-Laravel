        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            <div class="card-header py-0" id="kt_chat_contacts_header">
                <div class="card-title">
                    ...
                    <h3>Employee Leave Approved HR</h3>
                </div>
            </div>
            <!--end::Card header-->
            <!--begin::Card body-->
                ...
                <div class="row">
                    <div class="d-flex flex-row bd-highlight mb-3">
                        <div class="p-2 bd-highlight">
                            <a href="{{ route('employee_leave_approve_hr.index') }}"
                                class="btn btn-sm btn-primary px-3">Pendimg leave</a>
                        </div>
                        <div class="p-2 bd-highlight">
                            <a href="{{ route('employee_leave_approve_hr_list') }}"
                    ...
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0">
                        ...
                        <thead>
                            ...
                            <tr class="text-start  fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-120px sorting" style="width: 100px;">
                                    Dept Status</th>
                                <th class="min-w-80px sorting" style="width: 120px;">
                                    HR Status</th>
                                <th class="min-w-100px sorting" style="width: 100px;">
                                    Mang Status</th>
                                <th class="min-w-100px sorting" style="width: 100px;">
                                    Final Status</th>
                                @can('create leave approved hr')
                                <th class="min-w-20px sorting">
                                    Action</th>
                                @endcan
                            </tr>
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            ...
                            <form id="leaveForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                action="{{ route('employee_leave_approve_hr.update', $employeeDetail->id) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <select class="form-select form-select-sm" name="hr_status"
                                                required>
                                                <option value="1"
                                                    {{ $employeeDetail->hr_status==1?'selected':'' }}>Approved
                                                </option>
                                                <option value="0"
                                                    {{ $employeeDetail->hr_status==0?'selected':'' }}>Pending
                                                </option>
                                            </select>
                                        </div>
                                    </td>
