				...
				<div class="card card-flush">
					...
					<div class="card-header align-items-center py-5 gap-2 gap-md-5">
						...
						<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
							...
							<!--end::Filter-->
							@can('create employee designation')
                            <a href="{{ route('emp_designation.create') }}" class="btn btn-primary btn-sm">Add Designation</a>
							@endcan
						</div>
						<!--end::Card toolbar-->
					</div>
						...
						<table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"  id="kt_ecommerce_report_customer_orders_table" >
							...
							<thead>
								...
								<tr class="text-start fs-7 text-uppercase gs-0">
									...
									@can('write employee designation')
							...
							<tbody class="fw-semibold text-gray-700">
								...
								<tr>
                                    ...
                                    <td>
										<a class="text-dark text-hover-primary">{{$designation->designation_name}}</a>
									</td>
                                    <td>
										<div class="badge badge-light-{{$designation->status==1 ? 'success' : 'info'}}">{{ $designation->status==1?'Active':'Disabled' }}</div>
									</td>
									@can('write employee designation')
                                    <td class="text-end">
										<a href="{{ route('emp_designation.edit', $designation->id) }}"
