                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            table.row.add([
                                ...
                                d.eorder,d.employee_code,d.employee_name,d.department_name,d.designation_name,d.Total_Casual_Leave,d.Deu_Casual_leave,d.Late_Count,
                                
                                '<input type="text" class="form-control form-control-sm" name="late_leave[]" oninput="validateNumberInput(this)" value="' + late_leave + '">'
