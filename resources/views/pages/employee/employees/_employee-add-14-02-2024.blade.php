                                    ...
                                    <div class="col-12 col-md-3 me-lg-10">
                                        ...
                                        <div class="card card-flush py-4">
                                            {{-- <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" id="changeBranch"
                                            ...
                                            <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" name="line_id" required>
                                            ...
                                            <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" name="grade_id" required>
                                            ...
                                            <div class="card-body pt-0 pb-5">
                                                ...
                                                <input type="number" name="gross_salary" class="form-control form-control-sm mb-2"
                                                placeholder="Gross Salary" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                                            </div>
                                            <div class="card-body pt-0 pb-5">
                                                <label class="form-label">A/C Number</label>
                                                <input type="number" name="ac_number" class="form-control form-control-sm mb-2"
                                                placeholder="A/C Number" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                            </div>
                                            <div class="card-body pt-0 pb-5">
                                                <label class="required form-label">Salary Section</label>
                                                <select class="form-select form-select-sm" name="salary_section_id" required>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <input type="number" name="mobile" class="form-control form-control-sm mb-2"
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <input type="number" name="mobile_two" class="form-control form-control-sm mb-2"
                                                                placeholder="Mobile Number" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <select class="form-select form-select-sm" name="quite_type">
                                                    ...
                                                    <div class="card-body py-5">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                                <input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="status" />
