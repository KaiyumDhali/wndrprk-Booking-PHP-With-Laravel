        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body py-0">
                <form id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    method="POST" action="{{ route('employee_ledger.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="number" class="form-control form-control-sm"
                                    name="input_amount" value="" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-sm" name="remarks" value="">
                            </div>
                        </div>
                        <div class="col">
