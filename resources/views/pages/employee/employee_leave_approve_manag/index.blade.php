        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            <div class="card-header py-0" id="kt_chat_contacts_header">
                <div class="card-title">
                    ...
                    <h3>Employee Leave Approved Management</h3>
                </div>
            </div>
            <!--end::Card header-->
            <!--begin::Card body-->
                ...
                <div class="row">
                    <div class="d-flex flex-row bd-highlight mb-3">
                        <div class="p-2 bd-highlight">
                            <a href="{{ route('employee_leave_approve_manag.index') }}"
                                class="btn btn-sm btn-primary px-3">Pendimg leave</a>
                        </div>
                        <div class="p-2 bd-highlight">
                            <a href="{{ route('employee_leave_approve_manag_list') }}"
                    ...
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0">
                        ...
                        <thead>
                            ...
                            <tr class="text-start  fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px sorting">
                                    Name</th>
                                <th class="min-w-70px sorting">
                                    Application</th>
                                <th class="min-w-70px sorting" style="width: 90px;">
                                    Start Date</th>
                                <th class="min-w-70px sorting" style="width: 90px;">
                                    End Date</th>
                                ...
                                <th class="min-w-20px sorting">
                                    Remarks</th>
                                <th class="min-w-120px sorting" style="width: 100px;">
                                    Dept Status</th>
                                <th class="min-w-80px sorting" style="width: 100px;">
                                    HR Status</th>
                                <th class="min-w-100px sorting" style="width: 120px;">
                                    Mang Status</th>
                                <th class="min-w-100px sorting" style="width: 100px;">
                                    Final Status</th>

                                @can('create leave approved management')
                                <th class="min-w-20px sorting">
                                    Action</th>
                                @endcan
                            </tr>
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            ...
                            <form id="leaveForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                action="{{ route('employee_leave_approve_manag.update', $employeeDetail->id) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a class="text-gray-700 fs-7  mb-1">{{$employeeDetail->leave_application_date}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a class="text-gray-700 fs-7  mb-1">{{$employeeDetail->leave_start_date}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a class="text-gray-700 fs-7  mb-1">{{$employeeDetail->leave_end_date}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    {{-- <td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input type="text"
                                                ...
                                                value="{{$employeeDetail->total_days}}" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a id="leave_id"
                                                    class="text-gray-700 fs-7  mb-1">{{$employeeDetail->alternativeEmployeeId->employee_name}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input type="text" class="form-control form-control-sm form-control-solid" name="remarks"
                                                value="{{$employeeDetail->remarks}}" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                        <div
                                                class="badge badge-light-{{$employeeDetail->department_status==1 ? 'success' : 'info'}}">
                                                {{ $employeeDetail->department_status==1?'Approved':'Pending' }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <select class="form-select form-select-sm" name="management_status"
                                                required>
                                                <option value="1"
                                                    {{ $employeeDetail->management_status==1?'selected':'' }}>Approved
                                                </option>
                                                <option value="0"
                                                    {{ $employeeDetail->management_status==0?'selected':'' }}>Pending
                                                </option>
                                            </select>
                                        </div>
                                    </td>
