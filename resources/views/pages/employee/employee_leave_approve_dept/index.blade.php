                            ...
                            <form id="leaveForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a class="text-gray-700 fs-7  mb-1">{{$employeeDetail->employeeId->employee_name}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a class="text-gray-700 fs-7  mb-1">{{$employeeDetail->alternativeEmployeeId ? $employeeDetail->alternativeEmployeeId->employee_name : ''}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                <a
                                                    class="text-gray-700 fs-7  mb-1">{{$employeeDetail->leave_type}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <select class="form-select form-select-sm" data-control="select2" name="department_status"
                                                required>
                                                <option value="1"
