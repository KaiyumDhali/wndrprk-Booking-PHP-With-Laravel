                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <select id="changeBranch" name="branch_id" class="form-select form-select-sm readonly"
                                    required>
                        ...
                        <div class="col-md-2">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <select id="changeDepartment" name="department_id" class="form-select form-select-sm"
                                    required>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"
                        ...
                        <form id="kt_ecommerce_settings_general_form"
                            ...
                            action="{{ route('employee_leave_setting.update', 1) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <tbody class="fw-semibold text-gray-700" id="leave_settings">
                                {{-- @foreach($employeeLeaveSettings as $employeeLeaveSetting)
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a id="leave_id" class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->id}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->employee->employee_name}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->empDepartment->department_name}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->casual_leave}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->sick_leave}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->annual_leave}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->special_leave}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->total_leave}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="ms-5">
                                                <a class="text-gray-800 text-hover-primary fw-bold mb-1" >{{$employeeLeaveSetting->remarks}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-start">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px" role="document">
            <div class="modal-content">
                ...
                {{-- <form id="editForm"> --}}
                <form id="kt_modal_edit_card_form_leave_setting" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    method="POST" action="{{ route('update_leave_settings', ':editLeaveID') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="editCasualLeave" name="casualLeave">
                                </div>
                                <div class="form-group">
                                    <label for="editAnnualLeave">Annual Leave</label>
                                    <input type="text" class="form-control form-control-sm" id="editAnnualLeave" name="annualLeave">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="editSickLeave" name="sickLeave">
                                </div>
                                <div class="form-group">
                                    <label for="editSpecialLeave">Special Leave</label>
                                    <input type="text" class="form-control form-control-sm" id="editSpecialLeave" name="specialLeave">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="editRemarks">Remarks</label>
                                    <input type="text" class="form-control form-control-sm" id="editRemarks" name="remarks">
                                </div>
                            </div>
                        </div>
                    </div>
