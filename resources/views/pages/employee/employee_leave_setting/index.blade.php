<x-default-layout>
    ...
    <div class="col-xl-12 py-10">
        ...
        {{-- start single employee leave settimg  --}}
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-2">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <select class="form-select form-select-sm" data-control="select2"
                                    id="changeSectionWaiseSingleEmployee"  name="section_id" required>
                        ...
                        <div class="col-md-2">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <select class="form-select form-select-sm" data-control="select2" id="selectEmployee" name="employee_id" required>
                            ...
                            <div class="col-md-2">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="number" class="form-control form-control-sm" name="casual_leave"
                                        id="casual_leave_single" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="fv-row mb-7">
        ...
        {{-- start all employee leave settimg  --}}
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-2">
                            <div class="fv-row mb-0 fv-plugins-icon-container">
                                ...
                                <select class="form-select form-select-sm" data-control="select2" id="changeSection"
                        ...
                        @can('create leave setting')
                            ...
                            <div class="col-md-1">
                                <div class="fv-row mb-7 mt-8">
                                    ...
                                    <button type="submit" data-kt-contacts-type="submit" class="d-none btn btn-sm btn-primary"
                                        id="update">
    ...
    {{-- leave settings list  --}}
    <div class="card card-flush d-none" id="leave_settings_div">
        <!--begin::Card body-->
        <div class="card-body">
            <!--begin::Table-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm bg-light"
                                        id="editSectionName" name="sectiontName" readonly>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    // Defualt open list leave settings table data
    function CallBack() {
        $.ajax({
                        ...
                        $('#leave_settings').append(`
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <a id="leave_id" class="text-gray-800 text-hover-primary fw-bold mb-1" >${value.employee.employee_code}</a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="ms-5">
                                            <a class="text-gray-800 text-hover-primary fw-bold mb-1" >${value.emp_section.section_name}</a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-start">
                                    <button type="button" class="btn btn-sm btn-success p-2 edit-button"
                                            ...
                                            data-section-name="${value.emp_section.section_name}"
    ...
    // all employee Section on Change Work
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            var annual_leave = parseInt(value.annual_leave);
                            var special_leave = parseInt(value.special_leave);
                            totalLeave = casual_leave + sick_leave + annual_leave + special_leave;
    ...
    // single employee Section on Change Work
    $('#changeSectionWaiseSingleEmployee').on('change', function() {
        ...
        if (sectionID) {
            $.ajax({
                url: 'sectionWaiseSingleEmployee/' + sectionID,
                type: "GET",
                data: {
                    "_token": "{{ csrf_token() }}"
                },
    ...
    // Modal submite button is clicked
