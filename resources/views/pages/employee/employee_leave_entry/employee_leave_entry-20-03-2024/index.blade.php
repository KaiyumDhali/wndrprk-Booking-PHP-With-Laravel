                ...
                <form id="leaveForm" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                    ...
                    <div class="row mb-5">
                        ...
                        @can('create leave entry')
                            ...
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold form-label mt-0">
                                    <span class="required">Leave Reporting Date</span>
                                </label>
                                <input type="date" class="form-control form-control-sm" name="reporting_date"
                                    id="reporting_date" value="{{ date('Y-m-d', strtotime('+1 day')) }}" required>
                            </div>
                        </div> --}}
        ...
        if (employeeID) {
            $.ajax({
                ...
                success: function(leaveEntryDetails) {
                    if (leaveEntryDetails && leaveEntryDetails.length >
                        0) { // Ensure leaveEntryDetails is not empty
