...
<script type="text/javascript">
    ...
    $('#changeCustomer').on('change', function() {
        ...
        var customerName = $('#changeCustomer option:selected').text();
        ...
        if (customerID) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    const data = response.customerDetails;
                    ...
                    if (customerData) {
                        ...
                        console.log(customerMobile, customerAddress);
                    ...
                    if (data) {
                        ...
                        if (data.length > 0) {
                            ...
                            $.each(data, function(key, value) {
                                ...
                                table.row.add([d.id, d.invoice_no, d.ledger_date, d.remarks, d.credit, d.debit, balance.toFixed(2), 
                                ]).draw();
                            });
    ...
    function CallBack(pdfdata) {
        ...
        let url;
        url = '{{ route('customer_ledger_search', ['startDate' => ':startDate', 'endDate' => ':endDate', 'customerID' => ':customerID', 'pdf' => ':pdf']) }}';
