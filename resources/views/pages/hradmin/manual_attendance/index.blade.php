        ...
        <div class="card-body py-0">
            ...
            <div id="tableDiv" class="card-body pt-5 px-0">
                ...
                <form id="myForm">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <label for="kt_td_picker_linked_1_input" class="form-label">In Time</label>
                            <div class="input-group log-event" id="kt_td_picker_linked_1"
                                data-td-target-input="nearest" data-td-target-toggle="nearest">
                                <input type="text" name="in_time" id="kt_td_picker_linked_1_input"
                                    class="form-control form-control-sm" data-td-target="#kt_td_picker_linked_1"
                                    value="" />
                                <span class="input-group-text py-0" data-td-target="#kt_td_picker_linked_1"
                        ...
                        <div class="col-md-2">
                            <label for="kt_td_picker_linked_2_input" class="form-label">Out Time</label>
                            <div class="input-group log-event" id="kt_td_picker_linked_2"
                                data-td-target-input="nearest" data-td-target-toggle="nearest">
                                <input type="text" name="out_time" id="kt_td_picker_linked_2_input"
                                    class="form-control form-control-sm" data-td-target="#kt_td_picker_linked_2" />
                                <span class="input-group-text py-0" data-td-target="#kt_td_picker_linked_2"
                                    data-td-toggle="datetimepicker">
                                    <i class="ki-duotone ki-calendar fs-2"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
    ...
    function submitSelectedRows() {
        ...
        selectedRows.each(function() {
            ...
            let rowData = {
                ...
                'in_time': $('[name="in_time"]').val(),
                'out_time': $('[name="out_time"]').val(),
            };
        ...
        let url = '{{ route('add_selected_employee') }}';
