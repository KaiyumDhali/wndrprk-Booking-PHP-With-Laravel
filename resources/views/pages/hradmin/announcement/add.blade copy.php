                ...
                <div class="row px-10">
                    ...
                    <div class="col-md-12">
                        <div class="row me-0 me-md-2">
                            <div class="col-md-12 card shadow my-0 mb-2">
                                <div class="card-body py-1">
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            <div class="form-group col-md-4 pt-9">
                                                <h5 class="text-gray-800">{{ __('Company:') }}</h5>
                                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row me-0 me-md-2">
                            <div class="col-md-12 card shadow my-0">
                                <div class="card-body py-1">
                                    <div class="col-md-12 pb-3">
                                        <div class="row">
                                            <div class="form-group col-md-4 pt-9">
                    ...
                    <div class="col-md-6 mt-6">
                        <div class="row me-0 me-md-2">
                            ...
                            <div class="" style="padding-right: 0;">
                                <button type="button" id="addAnnouncement" class="btn btn-sm btn-primary px-10 mt-5  float-end">{{ __('ADD') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
