                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            ...
                                            <select id="employee_id" class="form-select form-select-sm"
                                                name="employee_id" data-control="select2" data-hide-search="false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                            <span class="">Select Company</span>
                                        </label>
                                        <!--end::Label-->
                                    ...
                                    {{-- <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <input type="text" id="lastPromotionDate"
                                                    class="form-control form-control-sm" name="start_date">
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div> --}}
                                    <!--end::Actions-->
                                </div>
                                ...
                                <div class="col-5">
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                        ...
                                        <select class="form-select form-select-sm" name="designation_id" id="changeDesignation" required>
                                            <option selected disabled>Select Employee Designation</option>
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        $.each(data, function(key, value) {
                            ...
                            // $('#lastPromotionDate').val('d.last_promotion.start_date');
                        });
                    } else {
