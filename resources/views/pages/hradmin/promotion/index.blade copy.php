<x-default-layout>
    ...
    <!--begin::Content-->
    <div id="addPro" class="app-content flex-column-fluid">
        <!--begin::Content container-->
                                        ...
                                        <div class="col-5">
                                            ...
                                            <form id="kt_modal_new_card_form"
                                                ...
                                                <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <!--end::Label-->
                                                    {{-- <select class="form-select form-select-sm selectpicker" data-live-search="true" id="employee_id" name="employee_id" required> --}}
                                                    <select id="employee_id" class="form-select form-select-sm"
    ...
    <!--                                                <div class="modal fade" id="kt_modal_new_card" tabindex="-1" aria-hidden="true">
                                ...
                                @csrf
                                    ...
                                    {{-- <select class="form-select form-select-sm selectpicker" data-live-search="true" id="employee_id" name="employee_id" required> --}}
                                                                                                                                <select id="employee_id" class="form-select form-select-sm" name="employee_id"
...
<script type="text/javascript">
    ...
    function myFunction() {
        var x = document.getElementById("kt_app_content_container");
        ...
        var y = document.getElementById("addpro");
