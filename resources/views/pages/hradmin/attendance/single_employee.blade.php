            ...
            <div class="card card-flush">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            <div class="card-body p-2">
                                <div class="product fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" id="selectBranch" value="{{ $employee->branch_id}}" hidden>
                                    <input type="text" id="employee_id" value="{{ $employee->employee_code}}" hidden>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body table-responsive pt-0">
                    <table class="table table-striped table-bordered align-middle table-row-dashed fs-7 gy-5 mb-0"
                        id="single_employee_attendance_report_table">
                        <thead>
                            <tr class="text-start fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-130px">Time ( <span class="text-danger">Late</span> / <span class="text-success">Early</span> )</th>
...
<script>
    ...
    var table = $('#single_employee_attendance_report_table').DataTable(dataTableOptions);
    ...
    function CallBack(pdfdata) {
        ...
        url =
            '{{ route('daily_attendance_search', ['branchID' => ':branchID', 'employeeID' => ':employeeID', 'startDate' => ':startDate', 'endDate' => ':endDate', 'pdf' => ':pdf']) }}';
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            table.row.add([d.ID, d.EmployeeName, d.department_name, d.designation_name, d._date, d.Day, 
                        ...
                        //     table.row.add([d.ID, d.EmployeeName, d.department_name, d.designation_name, d._date, d.Day, inTimeFormatted, outTimeFormatted,
                        //         (lateTimeValue !== null) ? `<span style="${lateTimeClass}">${d.LateTime}</span>` : '',
                        //         d.WorkTime
                        //     ]).draw();
