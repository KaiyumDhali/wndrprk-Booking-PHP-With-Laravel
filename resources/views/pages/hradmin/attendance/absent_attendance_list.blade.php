...
<script>
    ...
    function CallBack(pdfdata) {
        ...
        url =
            '{{ route('absent_attendance_search', ['employeeCode' => ':employeeCode', 'typeId' => ':typeId', 'departmentId' => ':departmentId', 'sectionId' => ':sectionId', 'lineId' => ':lineId', 'designationId' => ':designationId', 'startDate' => ':startDate', 'endDate' => ':endDate', 'pdf' => ':pdf']) }}';
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            let d = data[key];
                            console.log(d);
                            table.row.add([d.employee_code, d.employee_name, d.designation_name, d
                                .department_name, d.section_name, d.line_name, d._date,
                                `<span style="color: red">${d.remarks}</span>`,
                            ]).draw();
                        });
