                                                                                ...
                                                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                                                    ...
                                                                                    <tbody class="fw-semibold text-gray-600">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <form method="POST"
                                                                                                      action="{{route('promotion.destroy', $meeting->id)}}">
                                                                                                    {{csrf_field()}}
                                                                                                    {{ method_field('DELETE') }}
                                                                                                    <button type="button" class="btn btn-sm btn-success p-2"
                                                                                                        data-employeeMeeting="{{ json_encode($meeting) }}"
                                                                                                        onclick="openEditModalMeeting(this)">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                                                            ...
                                                                                            <form id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                                                                                  method="POST" action="{{ route('meeting.store') }}" enctype="multipart/form-data">
                            @csrf
                                                                                                ...
                                                                                                <div class="text-center pt-15">
                                                                                                    ...
                                                                                                    <a href="{{ route('meeting.index') }}" id="kt_modal_new_card_cancel"
                                                                            ...
                                                                            <div class="modal fade" id="kt_modal_edit_card" tabindex="-1" aria-hidden="true">
                                                                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                                                                                                                                                        <!--begin::Form-->
                                                                                            <form id="kt_modal_edit_card_form_meeting" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                                                                                  method="POST" action="{{ route('meeting.update',':meetingId') }}" enctype="multipart/form-data">
                                                                                                @csrf
                                                                                                @method('PUT')            
                                                                            ...
                                                                            // Meeting
                                                                            function openEditModalMeeting(button) {

                                                                                const meetingData = JSON.parse(button.getAttribute('data-employeeMeeting'));

                                                                                const formAction = $('#kt_modal_edit_card').find('#kt_modal_edit_card_form_meeting').attr('action');
                                                                                const meetingId = meetingData.id;
                                                                                const updatedFormAction = formAction.replace(':meetingId', meetingId);
                                                                                $('#kt_modal_edit_card').find('#kt_modal_edit_card_form_meeting').attr('action', updatedFormAction);

                                                                                $('#kt_modal_edit_card').find('input[name="title"]').val(meetingData.title);
                                                                                $('#kt_modal_edit_card').find('input[name="date"]').val(meetingData.date);
                                                                                $('#kt_modal_edit_card').find('input[name="time"]').val(meetingData.time);
                                                                                $('#kt_modal_edit_card').find('input[name="note"]').val(meetingData.note);
