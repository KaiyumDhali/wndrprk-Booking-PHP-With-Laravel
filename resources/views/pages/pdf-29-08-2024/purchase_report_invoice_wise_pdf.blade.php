...
<body style="font-size:12px">
    ...
    <div class="text-center">
        <h6 class="pb-0 mb-0 pt-0">Purchase Invoice</h6>
    </div>
        ...
        <tbody class="fw-semibold text-gray-600">
            ...
            @foreach ($stocks as $stock)
                <tr class="text-center">
                    ...
                    <td class="text-right">
                        {{ formatCurrency($productTotal = $stock->stock_in_quantity * $stock->stock_in_unit_price) }}
                    </td>
                    <span
            ...
            <tr>
                ...
                <td colspan="7" class="text-bold text-right" style="font-weight: bold;">
                    <span
                        class="double-underline">{{ formatCurrency($initialTotal - $initialDiscount - $supplierPayment) }}</span>
                </td>
            </tr>
            <!--end::Grand total-->
        </tbody>
    ...
    <p><b>In Word:</b> {{ numberToWord($initialTotal - $initialDiscount) }}</p>
    @if ($supplierPayment)
