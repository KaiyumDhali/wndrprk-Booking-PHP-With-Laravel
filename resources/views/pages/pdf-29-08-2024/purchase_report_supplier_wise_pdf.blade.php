...
<body style="font-size:12px">
    ...
    <div class="text-center">
        <h6 class="pb-0 mb-0 pt-0">Purchase Register</h6>
        ...
        @if ($dateWiseSalesSearch)
            <thead class="text-light bg-secondary ">
                <tr class="text-uppercase text-center" style="font-size: 13px; font-weight: bold">
                    ...
                    <th scope="col" class="text-center align-middle">Particulars</th>
                    ...
                    <th scope="col" class="text-center align-middle" width="45px">Debit <br> Amount</th>
                    <th scope="col" class="text-center align-middle" width="45px">Credit <br> Amount</th>
                </tr>
            </thead>
            <tbody>
                @php
