    ...
    <table class="table table-bordered table-striped table-sm table-hover pt-0">
        @if ($orderList)
            <thead class="text-light bg-secondary">
                ...
                <th scope="col" class="text-center align-middle" width="50px">SL</th>
                ...
                <th scope="col" class="text-center align-middle" width="90px">Delivery Date</th>
                <th scope="col" class="text-center align-middle" width="90px">Customer Name</th>
