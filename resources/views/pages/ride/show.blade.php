                    ...
                    <div class="card card-flush">
                        <div class="card-body py-5">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $ride->status == 1 ? 'Active' : 'Disable' }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="col-md-5">
                                    @if ($ride->image)
                                        <div class="form-group pb-2">
                                            <h5 class="pb-3">Ride Image:</h5>
                                            <img src="{{ asset(Storage::url($ride->image)) }}" height="220"
                                                width="320" alt="Ride Image" />
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <a class="btn btn-sm btn-primary me-2" href="{{ route('rides.index') }}"
                                    id="kt_ecommerce_add_product_cancel">Back</a>

                                <a class="btn btn-sm btn-info me-2" href="{{ route('rides.edit', $ride->id) }}"
