    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
            ...
            {{-- <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ route('rides.index') }}" class="btn btn-sm btn-light-primary">
        ...
        <div id="kt_app_content_container" class="app-container">
            <div class="card card-flush">
                ...
                <div class="card-body py-5">
                    <form action="{{ route('rides.update', $rides->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control form-control-solid" id="title" name="title"
                                value="{{ old('title', $rides->title) }}" />
                            {{-- <textarea class="form-control form-control-solid" id="title" name="title" rows="2">{{ old('title', $rides->title) }}</textarea> --}}
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5">{{ old('description', $rides->description) }}</textarea>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            @if ($rides->image)
                                <div class="mt-2">
                                    <img src="{{ asset(Storage::url($rides->image)) }}" height="75" width="75"
                                        alt="About Us Image" />

                                    @if ($rides->image != null)
                                        <a class="btn btn-sm btn-danger"
                                            onclick="return confirm('Are you sure you want to delete ?')"
                                            href="{{ route('ride.image_destroy', $rides->id) }}"><i
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select form-select-solid" id="status" name="status">
                                ...
                                <option value="1" {{ $rides->status == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $rides->status == 0 ? 'selected' : '' }}>Disable</option>
                            </select>
                        </div>

                        <div class="d-flex justify-content-end my-5">
                            <!--begin::Button-->
                            <a href="{{ route('rides.index') }}" id="kt_ecommerce_add_product_cancel"
