        ...
        @if ($monthlySalaries)
            ...
            <tbody>
                ...
                <tr style="text-uppercase">
                    <th class="min-w-50px text-center text-light bg-success " colspan="8">Total BDT</th>
                    <th class="min-w-80px text-light bg-success text-right">{{ $SumTotalPayable}}</th>
                    <th class="text-start min-w-80px text-light bg-success text-right">{{$SumTax}}</th>
                    <th class="text-start min-w-80px text-light bg-success text-right">{{$SumDPF}}</th>
                    <th class="text-start min-w-80px text-light bg-success text-right">{{$SumDOther}}</th>
                    <th class="text-start min-w-80px text-light bg-success text-right">{{$SumNetPayable}}</th>
                    <th class="text-start min-w-80px text-light bg-success text-right"></th>
                </tr>
            </tbody>
        @else
