    ...
    <body style="font-size:12px">
            ...
            <tbody>
                <tr class="text-center">
                    <td>
                        ...
                        <h6 class="">Product Sales Report</h6>
                    </td>
                </tr>
                <tr>
        ...
        <table class="">
            <thead class="">
                <tr class="">
                    <td>Customer ID :</td>
                    <td>{{ $stocks[0]->customer->id }}</td>
                </tr>
                <tr class="">
                    <td scope="col">Customer Name :</td>
                    <td>{{ $stocks[0]->customer->customer_name }}</td>
                </tr>
                <tr class="">
                    <td scope="col">Address :</td>
                    <td>{{ $stocks[0]->customer->customer_address }}</td>
                </tr>
                <tr class="">
                    <td scope="col">Mobile No :</td>
                    <td>{{ $stocks[0]->customer->customer_mobile }}</td>
                </tr>
            </thead>
        </table>
        ...
        <table class="" style="position: absolute; margin-top: -50px;" align="right">
            <thead class="" style="text-align: right;">
                <tr class="">
                    ...
                    <td>
                        <h6>(#{{ $stocks[0]->invoice_no }})</h6>
                    </td>
                </tr>
                <tr class="">
                    <td scope="col" style="text-align: right; font-weight: bold;">Invoice Date :</td>
        ...
        <table class="table table-bordered table-striped table-sm table-hover pt-3">
            ...
            <thead>
                <tr class="text-start text-uppercase text-center text-light bg-success ">
                    ...
                    <th class="min-w-70px">Quantity (Pcs/DOZ)</th>
            ...
            <span class="d-none text-right">{{ $initialTotal = $initialTotal + $productTotal, $initialDiscount = $initialDiscount + $stock->stock_out_discount }}</span>
        </tr>
            @endforeach
        <!--end::Products-->
        <!--begin::Subtotal-->
        ...
        <tr>
            ...
            <td colspan="7" class="text-right" style="font-weight: bold;">
                <span class="double-underline">{{ number_format($initialTotal - $initialDiscount - $customerPayment, 2) }}</spam>
            </td>
        </tr>
        <!--end::Grand total-->
    </tbody>
