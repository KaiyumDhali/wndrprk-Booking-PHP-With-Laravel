                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @forelse($offers as $offer)
                                <tr>
                                    ...
                                    <td>{{ $offer->title }}</td>
                                    <td><img src="{{ asset(Storage::url($offer->image)) }}" height="75"
                                            width="120" alt="Not Found" />
                                    </td>
                                    {{-- <td>{{ $offer->image_size }}</td> --}}
                                    <td>
                                        <span
                                            class="badge badge-light-{{ $offer->status == 1 ? 'success' : 'secondary' }}">
                                            {{ $offer->status == 1 ? 'Active' : 'Disable' }}
                                        </span>
                                    </td>
