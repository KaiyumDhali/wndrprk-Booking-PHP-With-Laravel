<a href="{{ route('total_supplier_payable_list') }}" class="card card-xl-stretch mb-5 mb-xl-8" style="background-color: #0000FF;">
    <!--begin::Body-->
    <div class="card-body">
        ...
        <div class="fw-semibold text-white">Total Payable Amount</div>
    </div>
    <!--end::Body-->
</a>
