<a href="{{ route('total_supplier_payable_list') }}" class="card card-xl-stretch mb-5 mb-xl-8" style="background-color: #4535C1;">
    <!--begin::Body-->
    <div class="card-body">
        ...
        <div class="fw-semibold text-white">Today Received Amount</div>
    </div>
    <!--end::Body-->
</a>
