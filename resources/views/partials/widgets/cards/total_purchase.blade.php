<a href="{{ route('purchase_invoice_list') }}" class="card bg-success  card-xl-stretch mb-5 mb-xl-8">
	<!--begin::Body-->
	<div class="card-body">
		...
		<!--end::Svg Icon-->
		<div class="text-white fw-bold fs-2 mb-2 mt-5">{{ formatCurrency($totalPurchaseCount) }} ৳</div>
		<div class="fw-semibold text-white">Total Purchase Amount</div>
	</div>
	<!--end::Body-->
</a>