<a href="{{ route('sales_invoice_list') }}" class="card bg-dark card-xl-stretch mb-xl-8">
	<!--begin::Body-->
	<div class="card-body">
		...
		<!--end::Svg Icon-->
		<div class="text-white fw-bold fs-2 mb-2 mt-5">{{ formatCurrency($totalSalesCount) }} ৳</div>
		<div class="fw-semibold text-white">Total Sales Amount</div>
	</div>
	<!--end::Body-->
</a>