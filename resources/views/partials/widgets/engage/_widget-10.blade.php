...
<div class="card card-flush h-md-100">
	...
	<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('assets/media/stock/900x600/42.png')">
		...
		<div class="mb-10">
			...
			<span class="me-2"> Shahjalal Equity Management Limited 
			<br />
			<span class="position-relative d-inline-block text-danger">
				...
				<!--end::Separator-->
			</span></span>for you</div>
			<!--end::Title-->
			
			<!--begin::Action-->
		</div>
		<img class="mx-auto h-150px h-lg-200px theme-light-show mb-10" src="{{ asset('assets/media/logos/default-small.png') }}" alt="" />
	</div>
	<!--end::Body-->
</div>
